...
public class ModRecipesProvider extends RecipeProvider {
    ...
    public void buildRecipes(@NotNull RecipeOutput recipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, Blocks.COBBLESTONE)
                ...
                .save(recipeOutput, prefix("cobblestone_from_rocks"));

        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, rockStone, 4)
                .requires(Blocks.COBBLESTONE)
                .unlockedBy("has_cobblestone", has(Blocks.COBBLESTONE))
                .save(recipeOutput, prefix("rocks_from_cobblestone"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, Items.FLINT)
                ...
                .save(recipeOutput, prefix("flint_from_shards"));
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(plantString), RecipeCategory.MISC, Items.STRING, 0.1F, 50)
                ...
                .save(recipeOutput, prefix("string_from_plant_string"));

        // Add condition for recipes to hide stuff if TinkerSurvival is loaded
        wrapped = recipeOutput.withConditions(new NotCondition(new ModLoadedCondition(SurvivalistEssentialsIntegration.TS_MODID)));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.STICK)
                ...
                .save(recipeOutput, prefix("stick_from_sapling"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.STRING, 2)
                ...
                .save(recipeOutput, prefix("string_from_wool"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.STRING, 4)
                ...
                .group("string")
                .unlockedBy("has_wool", has(ItemTags.WOOL))
                .save(recipeOutput, prefix("string_from_wool_advanced"));
        ...
        // Fruit Trees
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.FT_MODID));
        ...
        // Biome Makeover
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.BMO_MODID));
        ...
        //Biomes O' Plenty
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.BOP_MODID));
        ...
        //Quark
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.QUARK_MODID));
        ...
        //All You Can Eat
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.AYCE_MODID));
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.AYCE_HAZEL_PLANKS, TagManager.Items.AYCE_HAZEL_LOGS, "has_logs");

        // Tinkers' Construct
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.TCON_MODID));
        ...
        // Water Source
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.WS_MODID));
        ...
        // Botania
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.BOTANIA_MODID));
        ...
        // Ars Nouveau
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.AN_MODID));
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.AN_ARCHWOOD_PLANKS, ItemTags.create(loc("c", "logs/archwood")), "has_logs");

        // Undergarden
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.UNDERGARDEN_MODID));
        ...
        // BYG
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.BYG_MODID));
        ...
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BYG_SPIRIT_PLANKS, TagManager.Items.BYG_SPIRIT_LOGS, "has_logs");
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BYG_FLORUS_STEM, TagManager.Items.BYG_FLORUS_STEMS, "has_logs");

        // Twilight Forest
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.TF_MODID));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, Items.OAK_PLANKS, 64)
                ...
                .save(wrapped, loc(SurvivalistEssentialsIntegration.TF_MODID, "giant_log_to_oak_planks"));

        // Aquaculture
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.AQUA_MODID));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, Items.OAK_PLANKS, 2)
                ...
                .save(wrapped, loc(SurvivalistEssentialsIntegration.AQUA_MODID, "planks_from_driftwood"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, Items.OAK_PLANKS, 4)
                ...
                .group("planks")
                .unlockedBy("has_driftwood", has(TagManager.Items.AQUA_DRIFTWOOD))
                .save(wrapped, prefix("planks_from_driftwood"));

        // Immersive Engineering
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.IE_MODID));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, SurvivalistEssentialsIntegration.IE_STICK_TREATED, 2)
                ...
                .save(wrapped, prefix("stick_treated"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, SurvivalistEssentialsIntegration.IE_STICK_TREATED, 4)
                ...
                .group("treated_sticks")
                .unlockedBy("has_treated_planks", has(TagManager.Items.IE_TREATED_WOOD))
                .save(wrapped, loc(SurvivalistEssentialsIntegration.IE_MODID, "crafting/stick_treated"));

        // Ecologics
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.ECO_MODID));
        ...
        // Malum
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.MALUM_MODID));
        ...
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.IFD_MODID));
        ...
        // Regions Unexplored
        wrapped = recipeOutput.withConditions(new ModLoadedCondition(SurvivalistEssentialsIntegration.REGIONS_MODID));
        ...
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_BLACKWOOD_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_blackwood_branch");
        ...
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_BRIMWOOD_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_brimwood_branch");
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_COBALT_PLANKS, TagManager.Items.RU_COBALT_LOGS, "has_logs");
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_COBALT_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_cobalt_branch");
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_CYPRESS_PLANKS, TagManager.Items.RU_CYPRESS_LOGS, "has_logs");
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_CYPRESS_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_cypress_branch");
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_DARK_OAK_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_dark_oak_branch");
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_DEAD_PLANKS, TagManager.Items.RU_DEAD_LOGS, "has_logs");
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_DEAD_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_dead_branch");
        ...
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_EUCALYPTUS_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_eucalyptus_branch");
        ...
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_JOSHUA_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_joshua_branch");
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_JUNGLE_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_jungle_branch");
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_KAPOK_PLANKS, TagManager.Items.RU_KAPOK_LOGS, "has_logs");
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_KAPOK_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_kapok_branch");
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_LARCH_PLANKS, TagManager.Items.RU_LARCH_LOGS, "has_logs");
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_LARCH_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_larch_branch");
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_MANGROVE_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_mangrove_branch");
        ...
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_MAGNOLIA_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_magnolia_branch");
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_MAPLE_PLANKS, TagManager.Items.RU_MAPLE_LOGS, "has_logs");
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_MAPLE_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_maple_branch");
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_MAUVE_PLANKS, TagManager.Items.RU_MAUVE_LOGS, "has_logs");
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_MAUVE_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_mauve_branch");
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_OAK_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_oak_branch");
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_PALM_PLANKS, TagManager.Items.RU_PALM_LOGS, "has_logs");
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_PALM_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_palm_branch");
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_PINE_PLANKS, TagManager.Items.RU_PINE_LOGS, "has_logs");
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_PINE_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_pine_branch");
        ...
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_REDWOOD_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_redwood_branch");
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_SILVER_BIRCH_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_silver_birch_branch");
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_SOCOTRA_PLANKS, TagManager.Items.RU_SOCOTRA_LOGS, "has_logs");
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_SOCOTRA_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_socotra_branch");
        sticksFromBranchRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.RU_SPRUCE_BRANCH, SurvivalistEssentialsIntegration.REGIONS_MODID, "", "stick_from_spruce_branch");
    ...
    private static void sticksFromBranchRecipeBuilder(RecipeOutput recipeOutput, ItemLike item, String modid, String folder, String name) {
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.STICK, 2)
            ...
            .requires(SurvivalistEssentialsItems.CRUDE_SAW)
            .group("sticks")
            .unlockedBy("has_branch", has(item))
            .save(recipeOutput, loc(modid, folder + name));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.STICK, 4)
            ...
            .group("sticks")
            .unlockedBy("has_branch", has(item))
            .save(recipeOutput, prefix(modid + "_" + name));
    }
    ...
    private static void plankRecipeBuilder(RecipeOutput recipeOutput, ItemLike item, TagKey<Item> itemTag, String label) {
        ...
        if (modid.contains(SurvivalistEssentialsIntegration.TCON_MODID)) {
            plankOverrideRecipe.save(recipeOutput, loc(SurvivalistEssentialsIntegration.TCON_MODID, "world/wood/" + name.split("_")[0] + "/planks"));
        }
        else if (modid.contains(SurvivalistEssentialsIntegration.QUARK_MODID)) {
            plankOverrideRecipe.save(recipeOutput, loc(SurvivalistEssentialsIntegration.QUARK_MODID, "world/crafting/woodsets/" + name.split("_")[0] + "/planks"));
        }
        else if (modid.contains(SurvivalistEssentialsIntegration.MALUM_MODID)) {
            plankOverrideRecipe.save(recipeOutput, loc(SurvivalistEssentialsIntegration.MALUM_MODID, name));
        }
        else if (modid.contains(SurvivalistEssentialsIntegration.IFD_MODID)) {
            plankOverrideRecipe.save(recipeOutput, loc(SurvivalistEssentialsIntegration.IFD_MODID, "dread_wood_planks"));
        }
        else if (itemTag.equals(TagManager.Items.BYG_PALO_VERDE_LOGS)) {
            plankOverrideRecipe.save(recipeOutput, loc(SurvivalistEssentialsIntegration.BYG_MODID, "birch_planks_from_palo_verde_logs"));
    ...
    private static void itemPlankRecipeBuilder(RecipeOutput recipeOutput, ItemLike output, TagKey<Item> input, String label, String path, String name, String modid) {
        ...
        plankOverrideRecipe.save(recipeOutput, loc(modid, path + name));
