...
public class ItemTiers {
    ...
    public static final Tier IRON_TIER = new ItemTier().setMaxUses(320).setEfficiency(1.5F)
        .setAttackDamage(0.0F).setRepairMat(TagManager.Items.INGOTS_IRON);
    public static final Tier DIAMOND_TIER = new ItemTier().setMaxUses(640).setEfficiency(1.5F)
