...
public interface ISurvivalistEssentialsRecipeProvider {
    ...
    default void buildModRecipes(@NotNull RecipeOutput recipeOutput) {
        ...
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.AN_ARCHWOOD_PLANKS, TagManager.Items.ARCHWOOD_LOGS, "has_logs");
    ...
    default void plankRecipeBuilder(RecipeOutput recipeOutput, ItemLike item, TagKey<Item> itemTag, String label) {
    ...
    default void itemPlankRecipeBuilder(RecipeOutput recipeOutput, ItemLike output, TagKey<Item> input, String label, String path, String name, String modid) {
    ...
    default void bambooRecipeBuilder(RecipeOutput recipeOutput, ItemLike item, TagKey<Item> itemTag, String label) {
